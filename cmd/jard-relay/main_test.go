...
func TestForwardsParsing(t *testing.T) {
	for _, tc := range []struct {
		...
		{in: ":3000=jard-demo:3000", wantListen: ":3000", wantUp: "jard-demo:3000"},
		{in: "127.0.0.1:80=jard-demo:8080", wantListen: "127.0.0.1:80", wantUp: "jard-demo:8080"},
		...
		{in: ":3000=", wantErr: true},
		{in: "=jard-demo:3000", wantErr: true},
		{in: "", wantErr: true},
	} {
