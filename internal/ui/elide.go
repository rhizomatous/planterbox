...
// ellipsis is one rune, so it costs one rune of the budget it saves.
const ellipsis = "…"

// Elide shortens s to width runes by dropping the end, which is where prose
...
// ElidePath shortens s to width runes by dropping the front, because a path is
