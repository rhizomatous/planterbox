...
func (*Policy) Descriptor() ([]byte, []int) {
	return file_jard_proto_rawDescGZIP(), []int{0}
}
...
func (*Rule) Descriptor() ([]byte, []int) {
	return file_jard_proto_rawDescGZIP(), []int{1}
}
...
func (*Decision) Descriptor() ([]byte, []int) {
	return file_jard_proto_rawDescGZIP(), []int{2}
}
...
// State is what jard last observed about a sandbox.
//
...
var File_jard_proto protoreflect.FileDescriptor

const file_jard_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"jard.proto\x12\ajard.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"E\n" +
	"\x06Policy\x12\x16\n" +
	"\x06preset\x18\x01 \x01(\tR\x06preset\x12#\n" +
	"\x05rules\x18\x02 \x03(\v2\r.jard.v1.RuleR\x05rules\"6\n" +
	"\x04Rule\x12\x18\n" +
	...
	"\x06policy\x18\x01 \x01(\v2\x0f.jard.v1.PolicyR\x06policy\"\x13\n" +
	...
	"\x03env\x18\x02 \x03(\v2\x1d.jard.v1.ExecRequest.EnvEntryR\x03env\x12\x18\n" +
	...
	"\rCreateRequest\x12!\n" +
	"\x04spec\x18\x01 \x01(\v2\r.jard.v1.SpecR\x04spec\"<\n" +
	"\x0eCreateResponse\x12*\n" +
	"\asandbox\x18\x01 \x01(\v2\x10.jard.v1.SandboxR\asandbox\"\r\n" +
	"\vListRequest\">\n" +
	"\fListResponse\x12.\n" +
	"\tsandboxes\x18\x01 \x03(\v2\x10.jard.v1.SandboxR\tsandboxes\"0\n" +
	"\x0eInspectRequest\x12\x1e\n" +
	"\x03ref\x18\x01 \x01(\v2\f.jard.v1.RefR\x03ref\"=\n" +
	"\x0fInspectResponse\x12*\n" +
	"\asandbox\x18\x01 \x01(\v2\x10.jard.v1.SandboxR\asandbox\".\n" +
	"\fStartRequest\x12\x1e\n" +
	"\x03ref\x18\x01 \x01(\v2\f.jard.v1.RefR\x03ref\"\x0f\n" +
	"\rStartResponse\"-\n" +
	"\vStopRequest\x12\x1e\n" +
	"\x03ref\x18\x01 \x01(\v2\f.jard.v1.RefR\x03ref\"\x0e\n" +
	"\fStopResponse\"E\n" +
	"\rRemoveRequest\x12\x1e\n" +
	"\x03ref\x18\x01 \x01(\v2\f.jard.v1.RefR\x03ref\x12\x14\n" +
	"\x05force\x18\x02 \x01(\bR\x05force\"\x10\n" +
	"\x0eRemoveResponse\"O\n" +
	"\vCopyRequest\x12\x1f\n" +
	"\x03src\x18\x01 \x01(\v2\r.jard.v1.PathR\x03src\x12\x1f\n" +
	"\x03dst\x18\x02 \x01(\v2\r.jard.v1.PathR\x03dst\"\x0e\n" +
	"\fCopyResponse\".\n" +
	"\fStatsRequest\x12\x1e\n" +
	"\x03ref\x18\x01 \x01(\v2\f.jard.v1.RefR\x03ref\"~\n" +
	"\tExecStart\x12\x1e\n" +
	"\x03ref\x18\x01 \x01(\v2\f.jard.v1.RefR\x03ref\x12.\n" +
	"\arequest\x18\x02 \x01(\v2\x14.jard.v1.ExecRequestR\arequest\x12!\n" +
	"\x04size\x18\x03 \x01(\v2\r.jard.v1.SizeR\x04size\"\x10\n" +
	"\x0eExecStdinClose\"\xc3\x01\n" +
	"\x0fExecClientFrame\x12*\n" +
	"\x05start\x18\x01 \x01(\v2\x12.jard.v1.ExecStartH\x00R\x05start\x12\x16\n" +
	"\x05stdin\x18\x02 \x01(\fH\x00R\x05stdin\x12'\n" +
	"\x06resize\x18\x03 \x01(\v2\r.jard.v1.SizeH\x00R\x06resize\x12:\n" +
	"\vstdin_close\x18\x04 \x01(\v2\x17.jard.v1.ExecStdinCloseH\x00R\n" +
	"stdinCloseB\a\n" +
	"\x05frame\"m\n" +
	...
	"\aInspect\x12\x17.jard.v1.InspectRequest\x1a\x18.jard.v1.InspectResponse\x126\n" +
	...
	"\tSetPolicy\x12\x19.jard.v1.SetPolicyRequest\x1a\x1a.jard.v1.SetPolicyResponse\x12H\n" +
	"\vConnections\x12\x1b.jard.v1.ConnectionsRequest\x1a\x1c.jard.v1.ConnectionsResponseB;Z9github.com/rhizomatous/jardiniere/internal/api/rpc/jardv1b\x06proto3"

var (
	file_jard_proto_rawDescOnce sync.Once
	file_jard_proto_rawDescData []byte
)

func file_jard_proto_rawDescGZIP() []byte {
	file_jard_proto_rawDescOnce.Do(func() {
		file_jard_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_jard_proto_rawDesc), len(file_jard_proto_rawDesc)))
	})
...
func file_jard_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_jard_proto_goTypes,
		DependencyIndexes: file_jard_proto_depIdxs,
		MessageInfos:      file_jard_proto_msgTypes,
	}.Build()
	File_jard_proto = out.File
	file_jard_proto_goTypes = nil
	file_jard_proto_depIdxs = nil
}
